...
#[pyclass(name = "Rgba32", eq, hash, frozen, from_py_object)]
...
impl From<RCompOp> for CompOp {
    fn from(op: RCompOp) -> Self {
        match op {
            RCompOp::SrcOver => CompOp::SrcOver,
            RCompOp::SrcCopy => CompOp::SrcCopy,
            RCompOp::SrcIn => CompOp::SrcIn,
            RCompOp::SrcOut => CompOp::SrcOut,
            RCompOp::SrcAtop => CompOp::SrcAtop,
            RCompOp::DstOver => CompOp::DstOver,
            RCompOp::DstCopy => CompOp::DstCopy,
            RCompOp::DstIn => CompOp::DstIn,
            RCompOp::DstOut => CompOp::DstOut,
            RCompOp::DstAtop => CompOp::DstAtop,
            RCompOp::Xor => CompOp::Xor,
            RCompOp::Clear => CompOp::Clear,
            RCompOp::Plus => CompOp::Plus,
            RCompOp::Minus => CompOp::Minus,
            RCompOp::Modulate => CompOp::Modulate,
            RCompOp::Multiply => CompOp::Multiply,
            RCompOp::Screen => CompOp::Screen,
            RCompOp::Overlay => CompOp::Overlay,
            RCompOp::Darken => CompOp::Darken,
            RCompOp::Lighten => CompOp::Lighten,
            RCompOp::ColorDodge => CompOp::ColorDodge,
            RCompOp::ColorBurn => CompOp::ColorBurn,
            RCompOp::LinearBurn => CompOp::LinearBurn,
            RCompOp::LinearLight => CompOp::LinearLight,
            RCompOp::PinLight => CompOp::PinLight,
            RCompOp::HardLight => CompOp::HardLight,
            RCompOp::SoftLight => CompOp::SoftLight,
            RCompOp::Difference => CompOp::Difference,
            RCompOp::Exclusion => CompOp::Exclusion,
        }
    }
}
...
impl From<RFillRule> for FillRule {
    fn from(rule: RFillRule) -> Self {
        match rule {
            RFillRule::NonZero => FillRule::NonZero,
            RFillRule::EvenOdd => FillRule::EvenOdd,
        }
    }
}
...
impl From<RStrokeCap> for StrokeCap {
    fn from(cap: RStrokeCap) -> Self {
        match cap {
            RStrokeCap::Butt => StrokeCap::Butt,
            RStrokeCap::Square => StrokeCap::Square,
            RStrokeCap::Round => StrokeCap::Round,
        }
    }
}
...
impl From<RStrokeJoin> for StrokeJoin {
    fn from(join: RStrokeJoin) -> Self {
        match join {
            RStrokeJoin::MiterClip => StrokeJoin::MiterClip,
            RStrokeJoin::MiterBevel => StrokeJoin::MiterBevel,
            RStrokeJoin::MiterRound => StrokeJoin::MiterRound,
            RStrokeJoin::Bevel => StrokeJoin::Bevel,
            RStrokeJoin::Round => StrokeJoin::Round,
        }
    }
}
