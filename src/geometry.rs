...
#[pyclass(from_py_object, name = "Rect")]
...
impl Rect {
    ...
    pub(crate) fn from_inner(raden: raden::Rect) -> Self {
        Self { raden }
    }
}

/// 円を Python に露出する。
#[pyclass(from_py_object, name = "Circle")]
#[derive(Clone, Copy, Debug)]
pub struct Circle {
    raden: raden::Circle,
}
...
/// 楕円を Python に露出する。
#[pyclass(from_py_object, name = "Ellipse")]
#[derive(Clone, Copy, Debug)]
pub struct Ellipse {
    raden: raden::Ellipse,
}
...
/// 角丸矩形を Python に露出する。
#[pyclass(from_py_object, name = "RoundRect")]
#[derive(Clone, Copy, Debug)]
...
/// 三角形を Python に露出する。
#[pyclass(from_py_object, name = "Triangle")]
#[derive(Clone, Copy, Debug)]
pub struct Triangle {
...
/// 円弧を Python に露出する。
#[pyclass(from_py_object, name = "Arc")]
#[derive(Clone, Copy, Debug)]
pub struct Arc {
    raden: raden::Arc,
}
...
/// 2D の点を Python に露出する。
#[pyclass(from_py_object, name = "Point")]
#[derive(Clone, Copy, Debug)]
pub struct Point {
    #[pyo3(get, set)]
    pub x: f64,
